...
class _WoundInformationScreenState extends State<WoundInformationScreen> {
  ...
  void initState() {
    _sortByDate();
    _currentIndex = widget.woundEntrys.length - 1;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    WoundEntry _currentEntry = widget.woundEntrys[_currentIndex];
      ...
      body: SafeArea(
        ...
        children: [
              ...
              children: [
                Padding(
                  ...
                  child: IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          if (_currentIndex > 0) {
                            _currentEntry = widget.woundEntrys[_currentIndex--];
                          }
                        });
                      }),
                ),
                ...
                Padding(
                  ...
                  child: IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          if (_currentIndex < widget.woundEntrys.length - 1) {
                            _currentEntry = widget.woundEntrys[_currentIndex++];
                          }
                        });
                      }),
          ...
          Row(
              ...
              children: _currentEntry.images.asMap().entries.map((entry) {
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: AppColors.cura_darkBlue
                            .withOpacity(_currentPic == entry.key ? 0.9 : 0.4)),
                  ),
                );
              }).toList()),
          SizedBox(height: 20),
